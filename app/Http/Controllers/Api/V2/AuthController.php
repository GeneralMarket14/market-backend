...
class AuthController extends Controller
{
    public function signup(Request $request)
    {
        ...
        $messages = array(
            ...
            'number.required' => translate('Number is required'),
            'usertype.required' => translate('User Type is required'),
        ...
        $user->merchant_type = $request->usertype;
        if(strtolower($request->usertype) == 'customer'){
        ...
        if ($user->email_verified_at == null) {
            ...
            $shop->slug = preg_replace('/\s+/', '-', str_replace("/", " ", $request->name));
            $shop->save();
            }
